...
![logo](/articles/terraform-and-digitalocean-automating-infrastructure-and-catching-the-hidden-load-balancer/logo.jpg)
...
![folder structure](/articles/terraform-and-digitalocean-automating-infrastructure-and-catching-the-hidden-load-balancer/pic01.png)
...
![terraform backend](/articles/terraform-and-digitalocean-automating-infrastructure-and-catching-the-hidden-load-balancer/pic02.png)
...
2. Provisioning of ingress and apply any necessary workarounds as prescribed in the DigitalOcean documentation. [How to Set Up an Nginx Ingress with Cert-Manager on DigitalOcean Kubernetes](https://www.digitalocean.com/community/tutorials/how-to-set-up-an-nginx-ingress-with-cert-manager-on-digitalocean-kubernetes)
...
![resources](/articles/terraform-and-digitalocean-automating-infrastructure-and-catching-the-hidden-load-balancer/pic03.png)

... have DNS records.

![dns records](/articles/terraform-and-digitalocean-automating-infrastructure-and-catching-the-hidden-load-balancer/pic04.png)
...
![vpc error](/articles/terraform-and-digitalocean-automating-infrastructure-and-catching-the-hidden-load-balancer/pic05.png)

When I rerun the pipeline, this specific step executes without encountering any errors.

![pipeline success](/articles/terraform-and-digitalocean-automating-infrastructure-and-catching-the-hidden-load-balancer/pic06.png)

If you experienced this issue, please contact me or drop a comment.

Below, you will find a list of pipeline workflows:

![workflows](/articles/terraform-and-digitalocean-automating-infrastructure-and-catching-the-hidden-load-balancer/pic07.png)
