...
export default function OrganisationItem(organisation: Organisation) {
    return <div className={styles.organisationItem}>
        ...
        <a href={organisation.link} target="_blank" rel="noopener noreferrer">{organisation.bussinessField} ({organisation.country})</a>
    </div>;
}
